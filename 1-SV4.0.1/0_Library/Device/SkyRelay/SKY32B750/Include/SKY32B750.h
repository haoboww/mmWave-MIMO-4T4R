...
typedef struct {
    ...
    uint8_t  RESERVED_0[4];                          /**< 0xC */
    __IO uint32_t RXMGMASK;                          /**< Rx Mailboxes Global Mask Register, offset: 0x10 */
    __IO uint32_t RX14MASK;                          /**< Rx 14 Mask register, offset: 0x14 */
    __IO uint32_t RX15MASK;                          /**< Rx 15 Mask register, offset: 0x18 */
    __IO uint32_t ECR;                               /**< Error Counter, offset: 0x1C */
    __IO uint32_t ESR1;                              /**< Error and Status 1 register, offset: 0x20 */
    uint8_t  RESERVED_1[4];                          /**< 0x24 */
    __IO uint32_t IMASK1;                            /**< Interrupt Masks 1 register, offset: 0x28 */
    uint8_t  RESERVED_2[4];                          /**< 0x2C */
    __IO uint32_t IFLAG1;                            /**< Interrupt Flags 1 register, offset: 0x30 */
    __IO uint32_t CTRL2;                             /**< Control 2 register, offset: 0x34 */
    __I  uint32_t ESR2;                              /**< Error and Status 2 register, offset: 0x38 */
    uint8_t  RESERVED_3[8];                          /**< 0x3C, 0x40 */
    __I  uint32_t CRCR;                              /**< CRC Register, offset: 0x44 */
    __IO uint32_t RXFGMASK;                          /**< Rx FIFO Global Mask register, offset: 0x48 */
    __I  uint32_t RXFIR;                             /**< Rx FIFO Information Register, offset: 0x4C */
    __IO uint32_t CBT;                               /**< CAN Bit Timing Register, offset: 0x50 */
    uint8_t  RESERVED_4[44];                         /**< 0x54 ... 0x7C */
    __IO uint32_t RAMn[CAN_RAMn_COUNT];              /**< Embedded RAM, array offset: 0x80 ... 0x27C, array step: 0x4 */
    uint8_t  RESERVED_5[1536];                       /**< 0x280 ... 0x87C */
    __IO uint32_t RXIMR[CAN_RXIMR_COUNT];            /**< Rx Individual Mask Registers, array offset: 0x880 ... 0x8FC, array step: 0x4 */
    uint8_t  RESERVED_6[480];                        /**< 0x900 ... 0xADF */
    __IO uint32_t MECR;                              /**< Memory Error Control Register MECR  0xAE0   */
		__IO uint32_t ERRIAR;                            /**< Error Injection Address Register ERRIAR 0xAE4  */
		__IO uint32_t ERRIDPR;                           /**< Error Injection Data Pattern Register ERRIDPR 0xAE8 */
		__IO uint32_t ERRIPPR;                           /**< Error Injection Parity Pattern Register ERRIPPR 0xAEC */
		__I  uint32_t RERRAR;                            /**< Error Report Address Register RERRAR 0xAF0 */
		__I  uint32_t RERRDR;                            /**< Error Report Data Register RERRDR 0xAF4 */
		__I  uint32_t RERRSYNR;                          /**< Error Report Syndrome Register RERRSYNR 0xAF8 */
    __IO uint32_t ERRSR;                             /**< Error Status Register ERRSR 0xAFC   */
    ...
    uint8_t  RESERVED_7[24];                         /**< 0xB28 ...  0xB3C */
    ...
    } WMB[CAN_WMB_COUNT];                                /**< 0xB40 ... 0xB7C */
    uint8_t  RESERVED_8[128];                        /**< 0xB80 ... 0xBFC */
