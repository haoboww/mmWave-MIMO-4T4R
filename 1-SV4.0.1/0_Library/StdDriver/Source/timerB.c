...
uint8_t TMRB_mTimeout(uint8_t u8TimerNum, uint32_t u32Msec)
{
    ...
    case 0:
    {
        ...
        TMRB_Reset();
        NVIC_SetPriority (TMRB0_IRQn, NVIC_EncodePriority(NVIC_GetPriorityGrouping(),5, 0));
    ...
    case 1:
    {
        TMRB_CLK_ENABLE;  //enable wqtimer clock
        TMRB_Reset();
        NVIC_SetPriority (TMRB1_IRQn, NVIC_EncodePriority(NVIC_GetPriorityGrouping(),5, 0));
    ...
    case 2:
    {
        ...
        TMRB_CLK_ENABLE;  //enable wqtimer clock
        TMRB_Reset();
        NVIC_SetPriority (TMRB2_IRQn, NVIC_EncodePriority(NVIC_GetPriorityGrouping(),5, 0));
    ...
    case 3:
    {
        ...
        TMRB_CLK_ENABLE;  //enable wqtimer clock
        TMRB_Reset();
        NVIC_SetPriority (TMRB3_IRQn, NVIC_EncodePriority(NVIC_GetPriorityGrouping(),5, 0));
