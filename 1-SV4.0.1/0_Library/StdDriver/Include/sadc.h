...
#define SADC_TRIGGER         (SADC->TRIG |= SADC_TRIG_Msk          )    //Trigger sadc sample once
#define SADC_GET_EOC_FLG     (SADC->STA & SADC_EOC_Msk ? 1 : 0     )    //Check end of conversion flag
#define SADC_CLR_EOC_FLG     (SADC->STA |= SADC_EOC_Msk            )    //Clear end of conversion flag
