...
#define BB_ZO_Cfg0(zLen,mulFac,mode,thresSum)                                                                  (BB_REGB->ZO_CFG0 = \
                                                                                                                                                                                     (uint64_t)(zLen)<<BB_BIT24_POS|\
                                                                                               (uint64_t)(mulFac)<<BB_BIT20_POS|\
                                                                                                                                                                                             (uint64_t)(mode)<<BB_BIT16_POS|\
                                                                                                                                                                                             (uint64_t)(thresSum)<<BB_BIT0_POS)
#define BB_ZO_THRES_SUM_GET                     ((uint32_t)BB_REGB->ZO_CFG0&0xFFFF)
#define BB_ZO_STA0_absSum                                        (BB_REGB->ZO_STA0&(uint64_t)0xFFFFFFF)
/*********************************DMA*******************************************/
#define DMA_CFG0_TWICEMODE_NORMAL              (0)
#define DMA_CFG0_TWICEMODE_TWICE               (1)
...
#define BB_DMA_Cfg0(twiceMode,minmaxMode,flt2pf_lsf_en,flt2pf_sfb,jumpCnt,interCnt,intraCnt,wmode,dsize) (BB_REGB->DMA_CFG0 = \
...
#define BB_DMA_Cfg1(srcJumpInc,srcInterInc)       (BB_REGB->DMA_CFG1    = (uint64_t)(srcJumpInc )<<BB_BIT32_POS | (uint64_t)(srcInterInc)<<BB_BIT0_POS  )
#define BB_DMA_Cfg2(srcIntraInc,srcBaseAddr)      (BB_REGB->DMA_CFG2    = (uint64_t)(srcIntraInc)<<BB_BIT32_POS |(uint64_t)(srcBaseAddr)<<BB_BIT0_POS  )
#define BB_DMA_Cfg3(dstJumpInc,dstInterInc)       (BB_REGB->DMA_CFG3    = (uint64_t)(dstJumpInc )<<BB_BIT32_POS | (uint64_t)(dstInterInc)<<BB_BIT0_POS  )
#define BB_DMA_Cfg4(dstIntraInc,dstBaseAddr)      (BB_REGB->DMA_CFG4    = (uint64_t)(dstIntraInc)<<BB_BIT32_POS |(uint64_t)(dstBaseAddr)<<BB_BIT0_POS  )
#define BB_DMA_STA0_totalMaxVal                   (BB_REGB->DMA_STA0>>BB_BIT32_POS)
#define BB_DMA_STA0_totalMinVal                   (BB_REGB->DMA_STA0&(uint64_t)0xFFFFFFFF)
#define BB_DMA_STA1_maxJumpIdx                    (BB_REGB->DMA_STA1>>BB_BIT32_POS)
#define BB_DMA_STA1_maxInterIdx                   ((BB_REGB->DMA_STA1>>BB_BIT12_POS)&(uint64_t)0xFFF)
#define BB_DMA_STA1_maxIntraIdx                   (BB_REGB->DMA_STA1&(uint64_t)0xFFF)
#define BB_DMA_STA2_minJumpIdx                    (BB_REGB->DMA_STA2>>BB_BIT32_POS)
#define BB_DMA_STA2_minInterIdx                   ((BB_REGB->DMA_STA2>>BB_BIT12_POS)&(uint64_t)0xFFF)
#define BB_DMA_STA2_minIntraIdx                   (BB_REGB->DMA_STA2&(uint64_t)0xFFF)

/*********************************P1MUL*******************************************/
#define P1MUL_CFG0_NCOMODE_COS                  (1)
#define P1MUL_CFG0_NCOMODE_SIN                  (2)
#define P1MUL_CFG0_NCOMODE_COS_SIN              (3)
#define BB_P1MUL_Cfg0(ncoMode,nco,ap)                           (BB_REGB->P1MUL_CFG0  = (uint64_t)(ncoMode) <<BB_BIT56_POS|((uint64_t)(nco) << BB_BIT32_POS) | (ap))
#define BB_P1MUL_Cfg1(dstIntraInc,dstBaseAddr)                  (BB_REGB->P1MUL_CFG1  = ((uint64_t)(dstIntraInc) << BB_BIT32_POS) | (dstBaseAddr))
/*********************************FFT*******************************************/
#define FFTPT_16                                          (0)
#define FFTPT_32                                          (1)
#define FFTPT_64                                          (2)
...
#define BB_FFT_CMD0(sCmd)                                                           (BB_REGB->FFT_CMD0 = (uint64_t)(sCmd))
#define BB_FFT_Cfg0(rsfOutput,rfInput,useA,useB,inPt,fftPt,unloadEn,mode)           (BB_REGB->FFT_CFG0=(uint64_t)(rsfOutput)<<BB_BIT58_POS|(uint64_t)(rfInput)<<BB_BIT56_POS|(uint64_t)(useA)<<BB_BIT44_POS|(uint64_t)(useB)<<BB_BIT32_POS|(uint64_t)(inPt)<<BB_BIT12_POS|(uint64_t)(fftPt)<<BB_BIT8_POS|(uint64_t)(unloadEn)<<BB_BIT4_POS|(uint64_t)(mode)<<BB_BIT0_POS)
#define BB_FFT_Cfg1(winBaseAddr,outLsfEn,outSfb,inLsfEn,inSfb,winSize,winEn)        (BB_REGB->FFT_CFG1 = \
...
#define BB_FFT_Cfg2(dstIntraInc,dstBaseAddr)                                        (BB_REGB->FFT_CFG2    =  (uint64_t)(dstIntraInc) << BB_BIT32_POS|(uint64_t)(dstBaseAddr) << BB_BIT0_POS )
#define BB_FFT_STA0_curMaxVal                                                       (BB_REGB->FFT_STA0>>BB_BIT32_POS)
#define BB_FFT_STA0_curMaxIdx                                                       (BB_REGB->FFT_STA0&(uint64_t)0xFFF)
/*********************************P2*******************************************/
...
#define BB_P2_CFG0(jumpCnt,interCnt,intraCnt,rsfBit,sub_mode,mode)     (BB_REGB->P2_CFG0 = (uint64_t)(jumpCnt)<<BB_BIT44_POS |\
...
#define BB_P2_CFG1(src0JumpInc,src0InterInc)                           (BB_REGB->P2_CFG1 = (uint64_t)(src0JumpInc) << BB_BIT32_POS |(uint64_t)(src0InterInc) << BB_BIT0_POS)
#define BB_P2_CFG2(src0IntraInc,src0BaseAddr)                          (BB_REGB->P2_CFG2 = (uint64_t)(src0IntraInc) << BB_BIT32_POS |(uint64_t)(src0BaseAddr) << BB_BIT0_POS)
#define BB_P2_CFG3(src1JumpInc,src1InterInc)                           (BB_REGB->P2_CFG3 = (uint64_t)(src1JumpInc)  << BB_BIT32_POS |(uint64_t)(src1InterInc) << BB_BIT0_POS)
#define BB_P2_CFG4(src1IntraInc,src1BaseAddr)                          (BB_REGB->P2_CFG4 = (uint64_t)(src1IntraInc)  << BB_BIT32_POS |(uint64_t)(src1BaseAddr) << BB_BIT0_POS)
#define BB_P2_CFG5(dstJumpInc,dstInterInc)                             (BB_REGB->P2_CFG5 = (uint64_t)(dstJumpInc)  << BB_BIT32_POS |(uint64_t)(dstInterInc) << BB_BIT0_POS)
#define BB_P2_CFG6(dstIntraInc,dstBaseAddr)                            (BB_REGB->P2_CFG6 = (uint64_t)(dstIntraInc)  << BB_BIT32_POS |(uint64_t)(dstBaseAddr) << BB_BIT0_POS)
...
#define BB_P2_CFG7(src0ConjEn,src0LsfEn,src0Sfb,src1ConjEn,src1LsfEn,src1Sfb,dstConjEn,dstLsfEn,dstSfb) (BB_REGB->P2_CFG7 = \
...
#define BB_CFAR_CFG1(targetLim,srcInterInc)      (BB_REGB->CFAR_CFG1 = (uint64_t)(targetLim)<<BB_BIT32_POS |(uint64_t)(srcInterInc )<<BB_BIT0_POS)
#define BB_CFAR_CFG2(srcIntraInc,srcBaseAddr)    (BB_REGB->CFAR_CFG2 = (uint64_t)(srcIntraInc) <<BB_BIT32_POS|(uint64_t)(srcBaseAddr)<<BB_BIT0_POS )
#define BB_CFAR_CFG3(wrapAddrA,wrapAddrB)        (BB_REGB->CFAR_CFG3 = (uint64_t)(wrapAddrA) <<BB_BIT32_POS|(uint64_t)(wrapAddrB) <<BB_BIT0_POS )
#define BB_CFAR_CFG4(dstBaseAddr)                (BB_REGB->CFAR_CFG4 = (uint64_t)(dstBaseAddr) <<BB_BIT0_POS )
...
#define BB_DPK_CFG0(preData,preIdx,dpkTime,lenBW,mode)   (BB_REGB->DPK_CFG0 = (uint64_t)(preData)<<BB_BIT32_POS|(uint64_t)(preIdx )<<BB_BIT12_POS|(uint64_t)(dpkTime)<<BB_BIT8_POS |(uint64_t)(lenBW  )<<BB_BIT4_POS |(uint64_t)(mode   )<<BB_BIT0_POS )
#define BB_DPK_CFG1( srcIntraInc_a, srcBaseAddr_a)       (BB_REGB->DPK_CFG1 = (uint64_t)(srcIntraInc_a) <<BB_BIT32_POS|(uint64_t)(srcBaseAddr_a) <<BB_BIT0_POS)
#define BB_DPK_CFG2( srcIntraInc_b, srcBaseAddr_b)       (BB_REGB->DPK_CFG2 = (uint64_t)(srcIntraInc_b) <<BB_BIT32_POS|(uint64_t)(srcBaseAddr_b) <<BB_BIT0_POS)
#define BB_DPK_CFG3( refBaseAddr,dstBaseAddr)            (BB_REGB->DPK_CFG3 = (uint64_t)(refBaseAddr) <<BB_BIT32_POS|dstBaseAddr)
/***********************************buf_cfg0****************************************/
...
#define BUF_CFG0(wr_flt2pf_lsf_en,wr_flt2pf_sfb,convert_cpx_mode,rdPowMode)      (BB_REGB->BUF_CFG0 = (uint64_t)(wr_flt2pf_lsf_en)<<BB_BIT15_POS|\
...
#define BB_IMR_CLEAR(val)           (BB_REGB->IMR |= (uint64_t)val)
#define BB_IMR_SET(val)             (BB_REGB->IMR&=~((uint64_t)val))
#define BB_IMR_CLEAR_ALL            (BB_REGB->IMR = (uint64_t)(0xFFFFFFFFFFFFFFFFULL))
/*********************************EMR*******************************************/
...
#define BB_EMR_Init(val)             (BB_REGB->EMR&=~(uint64_t)(val))
/*********************************ISR*******************************************/
...
#define BB_ISR_CLEAR(val)           (BB_REGB->ISR = (uint64_t)(val))
#define BB_ISR_CLEAR_ALL            (BB_REGB->ISR = (uint64_t)(0xFFFFFFFFFFFFFFFFULL))
/*********************************ESR*******************************************/
...
#define BB_ESR_CLEAR(val)           (BB_REGB->ESR = (uint64_t)(val))
/*********************************OP_GATE*******************************************/
...
#define BB_OPGATE_EN(val)      (BB_REGB->OP_GATE &= ~(uint64_t)(val))
#define BB_OPGATE_DIS(val)     (BB_REGB->OP_GATE |= ((uint64_t)(val)))
/*********************************OP_TRIG*******************************************/
...
#define BB_OPTRIG(val)         (BB_REGB->OP_TRIG |= (uint64_t)(val))
/*********************************OP_CLEAR*******************************************/
...
#define BB_OPCLEAR(val)        (BB_REGB->OP_CLEAR |= (uint64_t)(val))
...
extern uint8_t BB_sampPT2reg(uint16_t sampPT);
extern uint8_t BB_samprate2reg(float sSamprate);
extern uint8_t BB_prepmode2reg(uint8_t sampBit);
extern uint8_t BB_prepBit2reg(uint8_t sampBit);
...
extern uint8_t fftPTcalc(uint16_t useRange);
extern uint8_t fft1dMeanDivCalc(uint16_t numChirp);
extern uint8_t log2Data(uint16_t dataIn);
#endif
