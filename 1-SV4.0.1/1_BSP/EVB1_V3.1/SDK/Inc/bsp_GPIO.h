...
//spi master or slave
#define SPIms_CS5_Pin GPIO_PIN_4
#define SPIms_CS5_GPIO_Port GPIO0
#define SPIms_CS5_WritePin  GPIO0_4
...
#define OSPI0_CS_Pin GPIO_PIN_0
#define OSPI0_CS_GPIO_Port GPIO0
#define OSPI0_CS_WritePin GPIO0_0 //
